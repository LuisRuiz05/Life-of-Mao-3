...
public class GamepadCursor : MonoBehaviour
{
    ...
    private enum WillUse
    {
        Menu,
        Inventory
    }
    [SerializeField]
    private WillUse actualUse;

    private void Start()
    {
        if (actualUse == WillUse.Menu)
        {
    ...
    private void OnEnable()
    {
        ...
        // Pair the device to the user to user the PlayerInput component with the Evet System & the Virtual Mouse.
